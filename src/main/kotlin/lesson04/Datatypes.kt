...
fun main() {
    ...
    val v6: Boolean = false // должно быть с маленькими
    val v7: Char = 'c'
    val v8: Int = 500
    ...
    val v19: Float = 5.75f
    val v20: Double = 1.414 // Используем обычное значение, без ковычек
    ...
    val v30: Boolean = false //надо использовать маленькие
    val v31: Double = 0.007
    val v32: String = "🤯" //неправильные кавычки
    val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)  ///
    val v34: String = "55535" // нужны другие, т.к. ' ' дня одиночных символов
