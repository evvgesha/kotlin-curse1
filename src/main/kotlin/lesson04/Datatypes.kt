...
fun main() {
    ...
    //val v6: = FALSE // должно быть с маленькими
    val v7: Char = 'c'
    val v8: Int = 500
    ...
    //val v13: Boolean/String = true если Boolean или "true" если String
    ...
    val v19: Float = 5.75f
    //val v20:  = `1.414` // Используем обычное значение, без ковычек
    val v21: String = "Artificial Intelligence"
    val v22: Array<Any> = arrayOf('x', "A") // либо сделать все кавычки одинарными, то Char, либо двойными - то String
    ...
    //val v44: = TRUE // должно быть маленькими буквами
}
...
// Хранить массу воздуха в спускающем матрасе после нападения кота в долях грамма.
 val girWeight: Double = 12.4839

//Хранить словарь «название стартапа - сумму потерь инвесторов».
 val startupLoses: Map<String, Double> = mapOf("БольшиеБукинси" to 4442.2323, "МалыеБукинги" to 3333.34436)

//Хранить строку «починилось само», чтобы закрывать тикеты без лишних слов.
 val fixText: String = "Починилось само"

//АХранить список тем для митингов, которые на самом деле никому не нужны.
